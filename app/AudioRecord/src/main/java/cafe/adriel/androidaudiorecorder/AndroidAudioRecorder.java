...
public class AndroidAudioRecorder {
    ...
    protected static final String EXTRA_BIT_DEPTH = "bitDepth";
    ...
    private int bitDepth = AudioFormat.ENCODING_PCM_16BIT; //Default
    ...
    public AndroidAudioRecorder setBitDepth(int bitDepth) {
    ...
    public void record() {
        ...
        intent.putExtra(EXTRA_BIT_DEPTH, bitDepth);
